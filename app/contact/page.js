    ...
    <>
      ...
      <main className="inner">
        ...
        <div className="page-intro contact-intro-section">
          ...
          <p>Have a question about our collections, need custom recommendations, or want to discuss an event? Drop us a line below.</p>
        </div>
        ...
        <section className="contact-redesign-layout">
          ...
          <div className="contact-info-cards">
            <div className="info-card-item">
              ...
              <div className="info-card-details">
                ...
                <a href="https://wa.me/94720295492" target="_blank" rel="noopener noreferrer">
                  +94 72 029 5492
                </a>
            ...
            <div className="info-card-item">
              ...
              <div className="info-card-details">
                ...
                <a href="https://maps.google.com/?q=Kirindiwela,Gampaha" target="_blank" rel="noopener noreferrer">
            ...
            <div className="info-card-item social-card-item">
              <div className="info-card-details">
                ...
                <p className="social-sub">Follow our green journey on social media</p>
                <SocialButtons />
              </div>
            </div>
          </div>
          ...
          <div className="contact-form-card">
            ...
            <p className="form-subtitle">Fill in the fields below, and our team will get back to you shortly.</p>
            <ContactForm />
          </div>
        </section>
        ...
        <section className="faq-section">
          <div className="faq-header">
            ...
            <p>Everything you need to know about our handcrafted floral arrangements and care guides.</p>
          </div>
          
          <div className="faq-accordion-list">
            {faqs.map((faq, idx) => (
              <details key={idx} className="faq-accordion-item">
                <summary className="faq-summary-title">
                  {faq.q}
                </summary>
